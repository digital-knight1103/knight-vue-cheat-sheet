<template>
    <div class="container px-4 h-full">
      <div class="relative py-24 md:py-64 px-8 bg-green-500 rounded-2xl overflow-hidden shadow-lg shadow-green-500/10">
        <img class="absolute top-0 left-0 h-full w-full object-cover" src="../../../assets/images/forest.png" alt="images banner">
        <!-- START CONTENT -->
        <div class="relative max-w-lg mx-auto text-center mb-12 z-10">
          <h3 class="text-3xl md:text-4xl font-bold text-white mb-3">Mały Przewodnik po VUE3</h3>
          <p class="font-medium text-blue-200 mb-6">Jedziemy z tematem</p>
